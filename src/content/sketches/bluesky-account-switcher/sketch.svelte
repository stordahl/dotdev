...
<div class="sketch">
	<button
		...
		class:open={dropDownState === 'open'}
	>
		<div class="avatar">
			<div>
				<img
					src="https://cdn.bsky.app/img/avatar_thumbnail/plain/did:plc:6ghbu76mogjyfcvx446mep5o/bafkreicuurghr37bo6zvzyciw72ximnc7ul7nmzftvoba5qyfpeoksawhq@jpeg"
					alt=""
				/>
			</div>
		</div>
...
<style>
	...
	#dropdown {
		...
		box-shadow:
			rgba(0, 0, 0, 0.4) 0px 10px 15px -3px,
			rgba(0, 0, 0, 0.4) 0px 4px 6px -4px,
